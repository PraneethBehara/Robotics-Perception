...
(cl:in-package pcd_object_detection-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <SegmentedClusters>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SegmentedClusters)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcd_object_detection-msg:<SegmentedClusters> is deprecated: use pcd_object_detection-msg:SegmentedClusters instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SegmentedClusters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcd_object_detection-msg:header-val is deprecated.  Use pcd_object_detection-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'clusters-val :lambda-list '(m))
(cl:defmethod clusters-val ((m <SegmentedClusters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcd_object_detection-msg:clusters-val is deprecated.  Use pcd_object_detection-msg:clusters instead.")
  (clusters m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SegmentedClusters>)))
  ...
  "pcd_object_detection/SegmentedClusters")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SegmentedClusters)))
  "Returns string type for a message object of type 'SegmentedClusters"
  "pcd_object_detection/SegmentedClusters")
