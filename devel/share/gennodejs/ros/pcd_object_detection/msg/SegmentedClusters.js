...
// (in-package pcd_object_detection.msg)
...
class SegmentedClusters {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SegmentedClusters(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentedClusters(null);
...
module.exports = SegmentedClusters;
